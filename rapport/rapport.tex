...
\\ Le bits de parité nous permet de savoir si lors de la transmition le message à été modifié simplement en regardant si le bit de parité correspond toujours au reste du message.
