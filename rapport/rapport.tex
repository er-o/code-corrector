...
Il existe plusieurs méthodes pour détecter les erreurs, par exemple associer un mot à une lettre comme utilisé dans l'armée :\linebreak
 \hspace{2cm} exemple : erreur  -> Echo Romeo Romeo Echo Uniforme Romeo
